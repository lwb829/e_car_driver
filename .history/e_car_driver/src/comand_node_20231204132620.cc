...
static e_car_driver_msgs::ADCU_CldDrvCmd cld_drive_command_msg;
...
static void power_callback(const e_car_driver_msgs::ADCU_PowerCmd &msg)
{
    power_command.Reset();
...
static void body_callback(const e_car_driver_msgs::ADCU_BodyCmd &msg)
{
    body_command.Reset();
...
static void cldbody_callback(const e_car_driver_msgs::ADCU_CldBodyCmd &msg)
{
...
static void cldpower_callback(const e_car_driver_msgs::ADCU_CldPowerCmd &msg)
{
