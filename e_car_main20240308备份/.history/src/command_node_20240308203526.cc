...
static int brake_prev_t = 0, park_prev_t = 0, steer_prev_t = 0, drive_prev_t = 0, body_prev_t=0; // 刹车，停车，转向，油门,灯光
...
int main(int argc, char **argv)
{
    ...
    ros::Timer set_speed = nh.createTimer(ros::Duration(1/40.0), timer_callback);
    ros::spin();
